...
from senteval.chn import LCQMCEval, PAWSXEval
...
class SE(object):
    ...
    def eval(self, name):
        ...
        if name == 'CR':
            ...
            self.evaluation = LCQMCEval(tpath + '/downstream/senteval_cn/LCQMC', seed=self.params.seed)
        elif name == 'PAWSX':
            self.evaluation = PAWSXEval(tpath + '/downstream/senteval_cn/PAWSX', seed=self.params.seed)
